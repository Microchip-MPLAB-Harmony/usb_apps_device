...
#define PMONC_CR_RW(value)                    (PMONC_CR_RW_Msk & (_UINT32_(value) << PMONC_CR_RW_Pos)) /* Assignment of value for RW in the PMONC_CR register */
...
#define PMONC_CR_BUSY(value)                  (PMONC_CR_BUSY_Msk & (_UINT32_(value) << PMONC_CR_BUSY_Pos)) /* Assignment of value for BUSY in the PMONC_CR register */
...
#define PMONC_CR_MASK_START(value)            (PMONC_CR_MASK_START_Msk & (_UINT32_(value) << PMONC_CR_MASK_START_Pos)) /* Assignment of value for MASK_START in the PMONC_CR register */
...
#define PMONC_CR_MASK_ENABLE(value)           (PMONC_CR_MASK_ENABLE_Msk & (_UINT32_(value) << PMONC_CR_MASK_ENABLE_Pos)) /* Assignment of value for MASK_ENABLE in the PMONC_CR register */
...
#define PMONC_CR_MASK_RSTN(value)             (PMONC_CR_MASK_RSTN_Msk & (_UINT32_(value) << PMONC_CR_MASK_RSTN_Pos)) /* Assignment of value for MASK_RSTN in the PMONC_CR register */
...
#define PMONC_CR_MASK_DIV_SEL(value)          (PMONC_CR_MASK_DIV_SEL_Msk & (_UINT32_(value) << PMONC_CR_MASK_DIV_SEL_Pos)) /* Assignment of value for MASK_DIV_SEL in the PMONC_CR register */
...
#define PMONC_CR_MASK_OSC_SEL(value)          (PMONC_CR_MASK_OSC_SEL_Msk & (_UINT32_(value) << PMONC_CR_MASK_OSC_SEL_Pos)) /* Assignment of value for MASK_OSC_SEL in the PMONC_CR register */
...
#define PMONC_CR_PM_START(value)              (PMONC_CR_PM_START_Msk & (_UINT32_(value) << PMONC_CR_PM_START_Pos)) /* Assignment of value for PM_START in the PMONC_CR register */
...
#define PMONC_CR_PM_ENABLE(value)             (PMONC_CR_PM_ENABLE_Msk & (_UINT32_(value) << PMONC_CR_PM_ENABLE_Pos)) /* Assignment of value for PM_ENABLE in the PMONC_CR register */
...
#define PMONC_CR_PM_RSTN(value)               (PMONC_CR_PM_RSTN_Msk & (_UINT32_(value) << PMONC_CR_PM_RSTN_Pos)) /* Assignment of value for PM_RSTN in the PMONC_CR register */
...
#define PMONC_CR_PM_DIV_SEL(value)            (PMONC_CR_PM_DIV_SEL_Msk & (_UINT32_(value) << PMONC_CR_PM_DIV_SEL_Pos)) /* Assignment of value for PM_DIV_SEL in the PMONC_CR register */
...
#define PMONC_CR_PM_OSC_SEL(value)            (PMONC_CR_PM_OSC_SEL_Msk & (_UINT32_(value) << PMONC_CR_PM_OSC_SEL_Pos)) /* Assignment of value for PM_OSC_SEL in the PMONC_CR register */
...
#define PMONC_CR_PM_ADDR(value)               (PMONC_CR_PM_ADDR_Msk & (_UINT32_(value) << PMONC_CR_PM_ADDR_Pos)) /* Assignment of value for PM_ADDR in the PMONC_CR register */
...
#define PMONC_REFCLKR_PCLK_DIV(value)         (PMONC_REFCLKR_PCLK_DIV_Msk & (_UINT32_(value) << PMONC_REFCLKR_PCLK_DIV_Pos)) /* Assignment of value for PCLK_DIV in the PMONC_REFCLKR register */
...
#define PMONC_REFCLKR_REFCLK_EN(value)        (PMONC_REFCLKR_REFCLK_EN_Msk & (_UINT32_(value) << PMONC_REFCLKR_REFCLK_EN_Pos)) /* Assignment of value for REFCLK_EN in the PMONC_REFCLKR register */
...
#define PMONC_SR_PM_FREQ(value)               (PMONC_SR_PM_FREQ_Msk & (_UINT32_(value) << PMONC_SR_PM_FREQ_Pos)) /* Assignment of value for PM_FREQ in the PMONC_SR register */
...
#define PMONC_SR_PM_ADDR(value)               (PMONC_SR_PM_ADDR_Msk & (_UINT32_(value) << PMONC_SR_PM_ADDR_Pos)) /* Assignment of value for PM_ADDR in the PMONC_SR register */
...
#define PMONC_SR_DONE(value)                  (PMONC_SR_DONE_Msk & (_UINT32_(value) << PMONC_SR_DONE_Pos)) /* Assignment of value for DONE in the PMONC_SR register */
...
#define PMONC_SR_NEW(value)                   (PMONC_SR_NEW_Msk & (_UINT32_(value) << PMONC_SR_NEW_Pos)) /* Assignment of value for NEW in the PMONC_SR register */
...
/* PMONC register offsets definitions */
