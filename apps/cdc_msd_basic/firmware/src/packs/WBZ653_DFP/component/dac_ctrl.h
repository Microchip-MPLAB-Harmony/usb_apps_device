...
#define DAC_CTRL_DAC_CODE_DATA(value)         (DAC_CTRL_DAC_CODE_DATA_Msk & (_UINT32_(value) << DAC_CTRL_DAC_CODE_DATA_Pos)) /* Assignment of value for DATA in the DAC_CTRL_DAC_CODE register */
