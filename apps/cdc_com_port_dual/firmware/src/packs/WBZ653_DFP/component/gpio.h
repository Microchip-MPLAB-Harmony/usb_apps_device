...
#define GPIO_CNCON_PORT32(value)              (GPIO_CNCON_PORT32_Msk & (_UINT32_(value) << GPIO_CNCON_PORT32_Pos)) /* Assignment of value for PORT32 in the GPIO_CNCON register */
...
#define GPIO_CNCON_CNSYTLE(value)             (GPIO_CNCON_CNSYTLE_Msk & (_UINT32_(value) << GPIO_CNCON_CNSYTLE_Pos)) /* Assignment of value for CNSYTLE in the GPIO_CNCON register */
