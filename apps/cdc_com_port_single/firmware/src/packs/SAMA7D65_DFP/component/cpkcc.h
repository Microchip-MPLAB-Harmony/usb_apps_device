...
#define CPKCC_R_VALUE(value)                  (CPKCC_R_VALUE_Msk & (_UINT32_(value) << CPKCC_R_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_R register */
...
#define CPKCC_X_VALUE(value)                  (CPKCC_X_VALUE_Msk & (_UINT32_(value) << CPKCC_X_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_X register */
...
#define CPKCC_Y_VALUE(value)                  (CPKCC_Y_VALUE_Msk & (_UINT32_(value) << CPKCC_Y_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_Y register */
...
#define CPKCC_Z_VALUE(value)                  (CPKCC_Z_VALUE_Msk & (_UINT32_(value) << CPKCC_Z_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_Z register */
...
#define CPKCC_J_VALUE(value)                  (CPKCC_J_VALUE_Msk & (_UINT32_(value) << CPKCC_J_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_J register */
...
#define CPKCC_K_VALUE(value)                  (CPKCC_K_VALUE_Msk & (_UINT32_(value) << CPKCC_K_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_K register */
...
#define CPKCC_N_VALUE(value)                  (CPKCC_N_VALUE_Msk & (_UINT32_(value) << CPKCC_N_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_N register */
...
#define CPKCC_SMULA_VALUE(value)              (CPKCC_SMULA_VALUE_Msk & (_UINT32_(value) << CPKCC_SMULA_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_SMULA register */
...
#define CPKCC_SMULB_VALUE(value)              (CPKCC_SMULB_VALUE_Msk & (_UINT32_(value) << CPKCC_SMULB_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_SMULB register */
...
#define CPKCC_SMULRL_VALUE(value)             (CPKCC_SMULRL_VALUE_Msk & (_UINT32_(value) << CPKCC_SMULRL_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_SMULRL register */
...
#define CPKCC_SMULRH_VALUE(value)             (CPKCC_SMULRH_VALUE_Msk & (_UINT32_(value) << CPKCC_SMULRH_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_SMULRH register */
...
#define CPKCC_IDLE_VALUE(value)               (CPKCC_IDLE_VALUE_Msk & (_UINT8_(value) << CPKCC_IDLE_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_IDLE register */
...
#define CPKCC_IDLECACHE_VALUE(value)          (CPKCC_IDLECACHE_VALUE_Msk & (_UINT8_(value) << CPKCC_IDLECACHE_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_IDLECACHE register */
...
#define CPKCC_CR_C_VALUE(value)               (CPKCC_CR_C_VALUE_Msk & (_UINT32_(value) << CPKCC_CR_C_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_CR_C register */
...
#define CPKCC_CR_S_VALUE(value)               (CPKCC_CR_S_VALUE_Msk & (_UINT32_(value) << CPKCC_CR_S_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_CR_S register */
...
#define CPKCC_CR_GF2N(value)                  (CPKCC_CR_GF2N_Msk & (_UINT32_(value) << CPKCC_CR_GF2N_Pos)) /* Assignment of value for GF2N in the CPKCC_CR register */
...
#define CPKCC_CR_CARRYIN(value)               (CPKCC_CR_CARRYIN_Msk & (_UINT32_(value) << CPKCC_CR_CARRYIN_Pos)) /* Assignment of value for CARRYIN in the CPKCC_CR register */
...
#define CPKCC_CR_ONEMUL(value)                (CPKCC_CR_ONEMUL_Msk & (_UINT32_(value) << CPKCC_CR_ONEMUL_Pos)) /* Assignment of value for ONEMUL in the CPKCC_CR register */
...
#define CPKCC_CR_ABORT(value)                 (CPKCC_CR_ABORT_Msk & (_UINT32_(value) << CPKCC_CR_ABORT_Pos)) /* Assignment of value for ABORT in the CPKCC_CR register */
...
#define CPKCC_CR_SPILLW(value)                (CPKCC_CR_SPILLW_Msk & (_UINT32_(value) << CPKCC_CR_SPILLW_Pos)) /* Assignment of value for SPILLW in the CPKCC_CR register */
...
#define CPKCC_CR_AWAKE(value)                 (CPKCC_CR_AWAKE_Msk & (_UINT32_(value) << CPKCC_CR_AWAKE_Pos)) /* Assignment of value for AWAKE in the CPKCC_CR register */
...
#define CPKCC_CR_PKCCIRQ(value)               (CPKCC_CR_PKCCIRQ_Msk & (_UINT32_(value) << CPKCC_CR_PKCCIRQ_Pos)) /* Assignment of value for PKCCIRQ in the CPKCC_CR register */
...
#define CPKCC_CR_ITEN(value)                  (CPKCC_CR_ITEN_Msk & (_UINT32_(value) << CPKCC_CR_ITEN_Pos)) /* Assignment of value for ITEN in the CPKCC_CR register */
...
#define CPKCC_CR_CLRRAM(value)                (CPKCC_CR_CLRRAM_Msk & (_UINT32_(value) << CPKCC_CR_CLRRAM_Pos)) /* Assignment of value for CLRRAM in the CPKCC_CR register */
...
#define CPKCC_CR_VALUE(value)                 (CPKCC_CR_VALUE_Msk & (_UINT32_(value) << CPKCC_CR_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_CR register */
...
#define CPKCC_OR_CMD0(value)                  (CPKCC_OR_CMD0_Msk & (_UINT32_(value) << CPKCC_OR_CMD0_Pos)) /* Assignment of value for CMD0 in the CPKCC_OR register */
...
#define CPKCC_OR_CMD1(value)                  (CPKCC_OR_CMD1_Msk & (_UINT32_(value) << CPKCC_OR_CMD1_Pos)) /* Assignment of value for CMD1 in the CPKCC_OR register */
...
#define CPKCC_OR_CMD2(value)                  (CPKCC_OR_CMD2_Msk & (_UINT32_(value) << CPKCC_OR_CMD2_Pos)) /* Assignment of value for CMD2 in the CPKCC_OR register */
...
#define CPKCC_OR_CMD3(value)                  (CPKCC_OR_CMD3_Msk & (_UINT32_(value) << CPKCC_OR_CMD3_Pos)) /* Assignment of value for CMD3 in the CPKCC_OR register */
...
#define CPKCC_OR_OPTM0(value)                 (CPKCC_OR_OPTM0_Msk & (_UINT32_(value) << CPKCC_OR_OPTM0_Pos)) /* Assignment of value for OPTM0 in the CPKCC_OR register */
...
#define CPKCC_OR_OPTM1(value)                 (CPKCC_OR_OPTM1_Msk & (_UINT32_(value) << CPKCC_OR_OPTM1_Pos)) /* Assignment of value for OPTM1 in the CPKCC_OR register */
...
#define CPKCC_OR_OPTC0(value)                 (CPKCC_OR_OPTC0_Msk & (_UINT32_(value) << CPKCC_OR_OPTC0_Pos)) /* Assignment of value for OPTC0 in the CPKCC_OR register */
...
#define CPKCC_OR_OPTC1(value)                 (CPKCC_OR_OPTC1_Msk & (_UINT32_(value) << CPKCC_OR_OPTC1_Pos)) /* Assignment of value for OPTC1 in the CPKCC_OR register */
...
#define CPKCC_OR_CARRYMUL(value)              (CPKCC_OR_CARRYMUL_Msk & (_UINT32_(value) << CPKCC_OR_CARRYMUL_Pos)) /* Assignment of value for CARRYMUL in the CPKCC_OR register */
...
#define CPKCC_OR_VALUE(value)                 (CPKCC_OR_VALUE_Msk & (_UINT32_(value) << CPKCC_OR_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_OR register */
...
#define CPKCC_SR_BUSY(value)                  (CPKCC_SR_BUSY_Msk & (_UINT32_(value) << CPKCC_SR_BUSY_Pos)) /* Assignment of value for BUSY in the CPKCC_SR register */
...
#define CPKCC_SR_CACHE(value)                 (CPKCC_SR_CACHE_Msk & (_UINT32_(value) << CPKCC_SR_CACHE_Pos)) /* Assignment of value for CACHE in the CPKCC_SR register */
...
#define CPKCC_SR_CARRY(value)                 (CPKCC_SR_CARRY_Msk & (_UINT32_(value) << CPKCC_SR_CARRY_Pos)) /* Assignment of value for CARRY in the CPKCC_SR register */
...
#define CPKCC_SR_ZERO(value)                  (CPKCC_SR_ZERO_Msk & (_UINT32_(value) << CPKCC_SR_ZERO_Pos)) /* Assignment of value for ZERO in the CPKCC_SR register */
...
#define CPKCC_SR_RAMV(value)                  (CPKCC_SR_RAMV_Msk & (_UINT32_(value) << CPKCC_SR_RAMV_Pos)) /* Assignment of value for RAMV in the CPKCC_SR register */
...
#define CPKCC_SR_SHAREV(value)                (CPKCC_SR_SHAREV_Msk & (_UINT32_(value) << CPKCC_SR_SHAREV_Pos)) /* Assignment of value for SHAREV in the CPKCC_SR register */
...
#define CPKCC_SR_CLRRAM_BUSY(value)           (CPKCC_SR_CLRRAM_BUSY_Msk & (_UINT32_(value) << CPKCC_SR_CLRRAM_BUSY_Pos)) /* Assignment of value for CLRRAM_BUSY in the CPKCC_SR register */
...
#define CPKCC_SR_VALUE(value)                 (CPKCC_SR_VALUE_Msk & (_UINT32_(value) << CPKCC_SR_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_SR register */
...
#define CPKCC_ADDRSIZE_VALUE(value)           (CPKCC_ADDRSIZE_VALUE_Msk & (_UINT32_(value) << CPKCC_ADDRSIZE_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_ADDRSIZE register */
...
#define CPKCC_IPNAME_VALUE(value)             (CPKCC_IPNAME_VALUE_Msk & (_UINT32_(value) << CPKCC_IPNAME_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_IPNAME register */
...
#define CPKCC_FEATURES_VALUE(value)           (CPKCC_FEATURES_VALUE_Msk & (_UINT32_(value) << CPKCC_FEATURES_VALUE_Pos)) /* Assignment of value for VALUE in the CPKCC_FEATURES register */
