...
/* Disable SERCOM interrupts */
...
#elif defined (_PIC32CM5112GC00100_H_)
    #define DISABLE_SERCOM_INTERRUPT() \
        SERCOM4_REGS->USART.SERCOM_INTENCLR = SERCOM_USART_INTENCLR_RXC_Msk;\
        SERCOM4_REGS->USART.SERCOM_INTENCLR = SERCOM_USART_INTENCLR_DRE_Msk;\
        SERCOM4_REGS->USART.SERCOM_INTENCLR = (uint8_t)SERCOM_USART_INTENSET_ERROR_Msk; \
        SERCOM4_REGS->USART.SERCOM_INTENCLR =  (uint8_t)SERCOM_USART_INTENSET_RXC_Msk;
       
    #define ENABLE_SERCOM_INTERRUPT() \
        SERCOM4_REGS->USART.SERCOM_INTENSET = SERCOM_USART_INTENSET_RXC_Msk;\
        SERCOM4_REGS->USART.SERCOM_INTENSET = SERCOM_USART_INTENSET_DRE_Msk;\
 ...
 #elif defined (_PIC32CK2051GC01144_H_)
    #define DISABLE_SERCOM_INTERRUPT() \
        ...
        SERCOM5_REGS->USART_INT.SERCOM_INTENCLR = (uint8_t)SERCOM_USART_INT_INTENSET_ERROR_Msk; \
        SERCOM5_REGS->USART_INT.SERCOM_INTENCLR =  (uint8_t)SERCOM_USART_INT_INTENSET_RXC_Msk;
       
    #define ENABLE_SERCOM_INTERRUPT() \
        SERCOM5_REGS->USART_INT.SERCOM_INTENSET = SERCOM_USART_INT_INTENSET_RXC_Msk;\
        SERCOM5_REGS->USART_INT.SERCOM_INTENSET = SERCOM_USART_INT_INTENSET_DRE_Msk;\
