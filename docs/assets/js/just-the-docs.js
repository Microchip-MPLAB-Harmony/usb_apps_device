...
{"0": {
    ...
    "doc": "CDC MSD SD Card Example",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is usb_apps_device/apps/cdc_msd_sdcard. Following table gives the details of project configurations, target device used, hardware and its IDE. Open the project using the respective IDE and build it. | Project Name | IDE | Target Device | Hardware / Configuration | . | pic32mx470_curiosity.X | MPLABX | PIC32MX470F512H | PIC32MX Curiosity Development Board | . | pic32mz_ef_curiosity_2.X | MPLABX | PIC32MZ2048EFM144 | Curiosity PIC32MZ EF 2.0 Development Board | . | sam_9x60_ek_iar.IAR | IAR | SAM9X60 | SAM9X60-EK Evaluation Board | . ",
    ...
    "doc": "CDC MSD SD Card Example",
    "title": " Configuring the Hardware",
    "content": "Curiosity PIC32MX470 Development Board . | To run the demo, the following additional hardware is required: . | micro-sd Click board | micro-sd card | . | Insert the micro-sd click board into the Mikro BUS 1 connector on the Curiosity PIC32MX470 Development Board. | Insert the micro-SD card into the micro-SD Card slot of the micro-sd click board. | USB micro-B port J12 to connect the USB device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch S1 to trigger communication from the USB Device to the USB Host. | . Curiosity PIC32MZ EF 2.0 Development Board . | To run the demo, the following additional hardware is required: . | micro-sd Click board | micro-sd card | . | Insert the micro-sd click board into the Mikro BUS 1 connector on the Curiosity PIC32MZ EF 2.0 Development Board. | Insert the micro-SD card into the micro-SD Card slot of the micro-sd click board. | Use the USB micro-B port J201 to connect the USB Device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch SW1 to trigger communication from the USB Device to the USB Host. | . SAM9X60-EK Evaluation Board . | Setup the SD card . | Download harmony MPU bootstrap loader from this location. | Copy the downloaded boot loader binary (boot.bin) and generated application binary (harmony.bin) into the SD card. | Insert the SD card into the SDMMC connector J4 on the board. | Reset the board by pressing the Push Button SW3. | . | Jumpers J20, J21, and J13 must be open. | Jumper J2 and J3 must be shorted. | Connect the USB Micro-B port J22 on board to the computer using a micro USB cable (to enable the debug com port). | Connect the USB Micro-B Connector (J7) on the board to the computer using a micro USB cable. | LED D1 indicates USB Device Configuration Set Complete event (The USB device functionality has been activated by the USB Host). | Press the switch SW1 to trigger communication from the USB Device to the USB Host. Note: Reset push button on SAM9X60 EK is labeled as SW3 . | . ",
    ...
    "doc": "MSD Basic Example",
    "title": " Configuring the Hardware",
    "content": "PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit . | Use the micro-A/B port J4 (which is located on the bottom side of the board) to connect the USB Device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | . SAMD21 Xplained Pro Board . | Use TARGET USB connector on the board to connect the USB Device to the USB Host PC. | LED0 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | . SAME54 Xplained Pro Board . | Use TARGET USB connector on the board to connect the USB Device to the USB Host PC. | LED0 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | . Curiosity PIC32MZ EF 2.0 Development Board . | Use the USB micro-B port J201 to connect the USB Device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | . Curiosity PIC32MX470 Development Board . | Use the USB micro-B port J12 to connect the USB Device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch S1 to trigger communication from the USB Device to the USB Host. | . ",
    ...
    "doc": "MSD Multiple LUN Example",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is usb_apps_device/apps/msd_multiple_luns. Following table gives the details of project configurations, target device used, hardware and its IDE. Open the project using the respective IDE and build it. | Project Name | IDE | Target Device | Hardware / Configuration | . | pic32mx470_curiosity.X | MPLABX | PIC32MX470F512H | PIC32MX Curiosity Development Board | . | pic32mz_ef_curiosity_20.X | MPLABX | PIC32MZ2048EFM144 | Curiosity PIC32MZ EF 2.0 Development Board | . ",
    ...
    "doc": "Vendor Example",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is usb_apps_device/apps/vendor. Following table gives the details of project configurations, target device used, hardware and its IDE. Open the project using the respective IDE and build it. | Project Name | IDE | Target Device | Hardware / Configuration | . | pic32mz_ef_curiosity_2_0.X | MPLABX | PIC32MZ2048EFM144 | Curiosity PIC32MZ EF 2.0 Development Board | . | pic32mx470_curiosity.X | MPLABX | PIC32MX470F512H | PIC32MX Curiosity Development Board | . | pic32mz_ef_sk.X | MPLABX | PIC32MZ2048EFH144 | PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit | . | pic32mz_ef_sk_freertos.X | MPLABX | PIC32MZ2048EFH144 | PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit | . | sam_9x60_ek.X | MPLABX | SAM9X60 | SAM9X60-EK Evaluation Board | . | sam_9x60_ek_freertos.X | MPLABX | SAM9X60 | SAM9X60-EK Evaluation Board | . | sam_a5d2_xult_iar.IAR | IAR | ATSAMA5D27C | SAMA5D2 Xplained Ultra Board | . | sam_d21_xpro.X | MPLABX | ATSAMD21J18A | SAMD21 Xplained Pro Board | . | sam_e54_xpro.X | MPLABX | ATSAME54P20A | SAME54 Xplained Pro Board | . | sam_e54_xpro_freertos.X | MPLABX | ATSAME54P20A | SAME54 Xplained Pro Board | . | sam_e70_xult.X | MPLABX | ATSAME70Q21B | SAME70 Xplained Ultra Board | . | sam_e70_xult_freertos.X | MPLABX | ATSAME70Q21B | SAME70 Xplained Ultra Board | . | sam_g55_xpro.X | MPLABX | ATSAMG55J19 | SAMG55 Xplained Pro Board | . | sam_v71_xult.X | MPLABX | ATSAMV71Q21B | SAMV71 Xplained Ultra board | . ",
    ...
    "doc": "Vendor Example",
    "title": " Configuring the Hardware",
    "content": "Curiosity PIC32MZ EF 2.0 Development Board . | Use the USB micro-B port J201 to connect the USB Device to the USB Host PC. | LED2 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch SW1 to trigger communication from the USB Device to the USB Host. | . Curiosity PIC32MX470 Development Board . | Use the USB micro-B port J12 to connect the USB Device to the USB Host PC. | LED1 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch S1 to trigger communication from the USB Device to the USB Host. | . PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit . | Use the micro-A/B port J4 (which is located on the bottom side of the board) to connect the USB Device to the USB Host PC. | LED2 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch SW1 to trigger communication from the USB Device to the USB Host. | . SAM9X60-EK Evaluation Board . | Setup the SD card . | Download harmony MPU bootstrap loader from this location. | Copy the downloaded boot loader binary (boot.bin) and generated application binary (harmony.bin) into the SD card. | Insert the SD card into the SDMMC connector J4 on the board. | Reset the board by pressing the Push Button SW3. | . | Jumpers J20, J21, and J13 must be open. | Jumper J2 and J3 must be shorted. | Connect the USB Micro-B port J22 on board to the computer using a micro USB cable (to enable the debug com port). | Connect the USB Micro-B Connector (J7) on the board to the computer using a micro USB cable. | LED D1 indicates USB Device Configuration Set Complete event (The USB device functionality has been activated by the USB Host). | Press the switch SW1 to trigger communication from the USB Device to the USB Host. Note: Reset push button on SAM9X60 EK is labeled as SW3 . | . SAMA5D2 Xplained Ultra Board . | Setup the SD card . | Download harmony MPU bootstrap loader from this location | Copy the downloaded boot loader binary( boot.bin) and generated application binary (harmony.bin)into the SD card | Insert the SD card into the SDMMC1 slot on the board | . | Short jumper JP2(DEBUG_DIS) | Connect the Debug USB port on the board to the computer using a micro USB cable | Use “A5-USB-A” connector(J23 - Micro A/B connector) on the board to connect the USB Device to the USB Host. | RGB LED turning to Green indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press PB_USER Switch to trigger communication from the USB Device to the USB Host | . SAMD21 Xplained Pro Board . | Use TARGET USB connector on the board to connect the USB Device to the USB Host PC. | LED0 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch SW0 to trigger communication from the USB Device to the USB Host. | . SAME54 Xplained Pro Board . | Use TARGET USB connector on the board to connect the USB Device to the USB Host PC. | LED0 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch SW0 to trigger communication from the USB Device to the USB Host. | . SAME70 Xplained Ultra Board . | Jumper J203 must be shorted between PB08 and VBUS (positions 2 and 3). | Use TARGET USB J200 connector on the board to connect the USB Device to the USB Host PC. | LED3 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch SW1 to trigger communication from the USB Device to the USB Host. | . SAMG55 Xplained Pro Board . | Use TARGET USB connector on the board to connect the USB Device to the USB Host PC. | LED0 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | Press the switch SW0 to trigger communication from the USB Device to the USB Host. | . SAMV71 Xplained Ultra board . | Jumper titled “USB VBUS” must be shorted between PC09 and VBUS (positions 2 and 3) | Use TARGET USB connector on the board to connect the USB Device to the USB Host PC. | LED0 indicates USB Device Configuration Set Complete event (the USB device functionality has been activated by the USB Host). | . ",
...
var repo_name = "usb_apps_device";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 USB Device application examples";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/usb_apps_device/assets/css/just-the-docs-' + theme + '.css');
}
